...
const navigationInfo = [
    {
        name: 'Home',
        icon: <IoHome  className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop',
    },
    {
        name: 'Your Favorites',
        icon: <HeartFilledIcon  className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/favorites',
    },
    {
        name: 'This Week',
        icon: <GiFire className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: `/shop/gamelist/this-week?ordering=-added&page_size=20&dates=${get7DaysGap()}`,
    },
    {
        name: 'Last 30 Days',
        icon: <TbRewindBackward30 className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: `/shop/gamelist/last-30-days?dates=${get30DaysGap()}&ordering=-rating&page_size=20`,
    },
    {
        name: 'Next 30 Days',
        icon: <TbRewindForward30 className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: `/shop/gamelist/next-30-days?ordering=-added&page_size=20&dates=${get30DaysNextGap()}`,
    },
    {
        name: 'Top of All Time',
        icon: <GiLaurelCrown className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
    ...
    },
    {
        ...
        icon: <GiLaurelsTrophy className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
    ...
    },
    {
        ...
        icon: <GiDiamondTrophy className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
    ...
    {
        name: 'PC',
        icon: <FaWindows className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/pc?ordering=-added&page_size=20&parent_platforms=1',
    },
    {
        name: 'Xbox',
        icon: <FaXbox className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/xbox?ordering=-added&page_size=20&parent_platforms=3',
    },
    {
        name: 'PlayStation',
        icon: <FaPlaystation className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/playstation?ordering=-added&page_size=20&parent_platforms=2',
    },
    {
        name: 'Nintendo Switch',
        icon: <BsNintendoSwitch className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/nintendo-switch?ordering=-added&page_size=20&parent_platforms=7',
    },
    {
        name: 'Action',
        icon: <RiBoxingFill className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/action?ordering=-added&page_size=20&genres=4',
    },
    {
        name: 'Adventure',
        icon: <FaCampground className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/adventure?ordering=-added&page_size=20&genres=3',
    },
    {
        name: 'RPG',
        icon: <GiBouncingSword className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/rpg?ordering=-added&page_size=20&genres=5',
    },
    {
        name: 'Strategy',
        icon: <FaChessRook className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/strategy?ordering=-added&page_size=20&genres=10',
    },
    {
        name: 'Sports',
        icon: <MdOutlineSportsBasketball className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
        path: '/shop/gamelist/sports?ordering=-added&page_size=20&genres=15',
    },
    {
        name: 'Puzzle',
        icon: <IoExtensionPuzzle className="w-5 h-5 xl:w-7 xl:h-7 text-white"/>,
